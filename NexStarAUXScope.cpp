...
void NexStarAUXScope::readMsgs()
{
    ...
    while (1)
    {
	if (nevo_tty_read(PortFD,(char*)buf,sizeof(buf),READ_TIMEOUT,&n) != TTY_OK)
            return;
	...
	if (n < 1)
        ...
        if (i > 0)
        {
            ...
            if (nevo_tty_read(PortFD, (char*)buf, i, 0, &n) != TTY_OK)
                return;
...
// and tty_write.
// 15-Feb-2020 Fabrizio Pollastri <mxgbot@gmail.com>
////////////////////////////////////////////////////////////////////////////////
